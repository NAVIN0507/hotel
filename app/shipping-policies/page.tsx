      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="text-center mb-12 sm:mb-16">
          ...
          <p className="text-gray-600 text-base sm:text-lg max-w-3xl mx-auto">
            Learn about our delivery process, shipping times, and what to expect when you order from us.
          </p>
        </div>
              ...
              dangerouslySetInnerHTML={{
                __html: data?.shipping || `
                  <div class="text-center py-12">
                    ...
                    <p class="text-gray-500 text-lg">No shipping policy found.</p>
                    <p class="text-gray-400 text-sm mt-2">Please contact us for delivery information.</p>
                  </div>
                `,
              }}
            />
        ...
        <div className="mt-8 grid grid-cols-1 md:grid-cols-1 gap-6">
          ...
          <div className="bg-gradient-to-br from-[#b79464] to-[#a67c52] rounded-xl p-6 sm:p-8 text-white">
            <div className="flex items-start gap-4">
              <div className="w-12 h-12 bg-white bg-opacity-20 rounded-lg text-black flex items-center justify-center flex-shrink-0">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm opacity-90 mb-4">
                  Contact us for any questions about delivery times or shipping methods.
                </p>
        ...
        <div className="mt-6 text-center">
          <p className="text-sm text-gray-500">
            Our shipping policy is subject to change. Please review for the most current information.
          </p>
        </div>
      </div>
    </section>
