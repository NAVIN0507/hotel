...
const MobileRoomInfo = ({ id })=>{
    ...
    const numberOfNights = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "MobileRoomInfo.useMemo[numberOfNights]": ()=>{
    ...
    const totalPrice = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "MobileRoomInfo.useMemo[totalPrice]": ()=>{
            ...
            const roomServiceNames = roomDetails?.services?.map({
                "MobileRoomInfo.useMemo[totalPrice]": (s)=>normalize(s.service_name)
            }["MobileRoomInfo.useMemo[totalPrice]"]) || [];
            ...
            Object.entries(addAct).forEach({
                "MobileRoomInfo.useMemo[totalPrice]": ([key, value])=>{
                    ...
                    if (roomServiceNames.includes(normalizedKey) && bookingDetails[normalizedKey] === true) {
                    ...
                    !userToken && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$client$2f$app$2d$dir$2f$link$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                            ...
                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Button"], {
                                className: "w-full p-4 h-20 text-2xl bg-[#AA9061] text-white hover:bg-[#AA9061] hover:text-white",
                                ...
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                className: "w-full px-4 py-3 flex  gap-3 bg-gradient-to-r items-center from-[#1a2f4a] to-[#2a3f5a] border border-[#3a4f6a] rounded-xl text-white focus:outline-none focus:ring-2 focus:ring-[#AA9061] transition-all duration-200 hover:border-[#AA9061] cursor-pointer",
                                                children: [
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("input", {
                                                        type: "checkbox",
                                                        name: "",
...
_s(MobileRoomInfo, "ciOjJ1nbnotnUiQEq9RMVlG+7sE=", false, function() {
    return [
...
const RoomInfo = ({ id })=>{
    ...
    const totalPrice = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "RoomInfo.useMemo[totalPrice]": ()=>{
            ...
            // Get the list of services available for this room
            const roomServiceNames = roomDetails?.services?.map({
                "RoomInfo.useMemo[totalPrice]": (s)=>normalize(s.service_name)
            }["RoomInfo.useMemo[totalPrice]"]) || [];
            let perNightExtras = 0;
            let oneTimeExtras = 0;
            // Only process addAct entries that match room services
            Object.entries(addAct).forEach({
                "RoomInfo.useMemo[totalPrice]": ([key, value])=>{
                    ...
                    if (roomServiceNames.includes(normalizedKey) && bookingDetails[normalizedKey] === true) {
                        ...
                        // Check if key starts with "extra_bed" to handle variations like "extra_bed1", "extra_bed2", etc.
                        if (normalizedKey.startsWith("extra_bed")) {
                            console.log("🛏️ Extra bed added as ONE-TIME charge:", price);
                            oneTimeExtras += price;
                        } else {
                            console.log(`📦 ${key} added as PER-NIGHT charge:`, price);
                            perNightExtras += price;
                        }
                    }
                }
            ...
            const roomTotal = basePrice * numberOfNights;
            const extrasTotal = perNightExtras * numberOfNights;
            const total = roomTotal + extrasTotal + oneTimeExtras;
                                                ...
                                                children: [
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        ...
                                                        children: [
                                                            ...
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                className: "jsx-121062add2f55945" + " " + "w-full px-4 py-3 flex  gap-3 bg-gradient-to-r items-center from-[#1a2f4a] to-[#2a3f5a] border border-[#3a4f6a] rounded-xl text-white focus:outline-none focus:ring-2 focus:ring-[#AA9061] transition-all duration-200 hover:border-[#AA9061] cursor-pointer",
                                                                children: [
                                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("input", {
                                                                        type: "checkbox",
                                                                        name: "",
                                                                        ...
                                                                        className: "jsx-121062add2f55945" + " " + "w-5 h-5"
                                                                    }, void 0, false, {
                                                                        fileName: "[project]/components/Room/RoomInfo.tsx",
                                                                        lineNumber: 660,
                                                                        columnNumber: 25
...
_s(RoomInfo, "ciOjJ1nbnotnUiQEq9RMVlG+7sE=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"]
    ];
});
...
//# sourceMappingURL=_7ce9c159._.js.map