  ...
  return (
    <section className="relative h-screen bg-cover bg-center rounded-2xl bg-hero w-full ">
      ...
      <div className="relative z-10 flex flex-col justify-center items-center h-full text-white text-center px-4">
        <p className="uppercase tracking-widest text-xs sm:text-sm mb-4">
          Relax on the most peaceful place – on Kodaikanal
        </p>
        ...
        <div className="mt-8 flex flex-col sm:flex-row gap-4 sm:gap-0 sm:items-center">
          <button className="px-5 py-2 sm:px-8 sm:pr-20 border border-white rounded-full bg-white/20 text-white hover:bg-white hover:text-black transition text-sm sm:text-base">
            Explore
          </button>
          <Link href="/allrooms">
