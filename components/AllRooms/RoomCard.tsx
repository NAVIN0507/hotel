            ...
            <div className="relative">
              ...
              <div className="w-fit p-3 h-12 bg-white  absolute -mt-14 right-0 mr-5 rounded-full">
                <div className="flex gap-1 items-center -mt-2">
                  <h1 className="font-mono text-[18px] -mt-2">
                    STARTS FROM <span className="text-3xl">{price} </span> /PER
                    NIGHT
                  </h1>
                  <button className="w-[150px] h-10 ml-4 bg-[#AA9061] rounded-full text-white">
                    EXPLORE
                  </button>
                </div>
              </div>
